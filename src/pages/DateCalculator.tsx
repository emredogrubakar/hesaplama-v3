              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-lg font-semibold text-gray-900">
                    {result.workDays.toLocaleString('tr-TR')}
                  </p>
                  <p className="text-sm text-gray-500">İş Günü</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-lg font-semibold text-gray-900">
                    {result.weekendDays.toLocaleString('tr-TR')}
                  </p>
                  <p className="text-sm text-gray-500">Hafta Sonu</p>
                </div>
              </div>
